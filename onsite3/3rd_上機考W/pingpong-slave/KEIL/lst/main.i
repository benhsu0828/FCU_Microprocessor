	...
	if(u32IntSts & (((((UART_T *) ((( uint32_t)0x40000000) + 0x50000)))->ISR & (1ul << 0))>>0)) 
  {
		while (!(((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR & (1ul << 14))){ 
			...
			if (c!='\n') {        
				...
				x = (comRbuf[0]-'0')*100+(comRbuf[1]-'0')*10+comRbuf[2]-'0';
				y = (comRbuf[3]-'0')*100+(comRbuf[4]-'0')*10+comRbuf[5]-'0';
				r = (comRbuf[6]-'0')*100+(comRbuf[7]-'0')*10+comRbuf[8]-'0';
...
int32_t main (void)
{
    ...
    while(1) {
			...
			sprintf(Text, "%03d\n",(u32ADCvalue/43));
			UART_Write(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)), Text, 4);
			
			draw_Bmp32x8(r,50,0xFFFF,0x0000,racket); 
			draw_Bmp32x8((u32ADCvalue/43),6,0xFFFF,0x0000,racket);	
